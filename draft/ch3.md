...
![An early conceptual diagram demonstrating possible interactions with the system](../diagrams/conceptDiagram.png)
...
FRQ10  |  Each team member can see how many other members have completed a given task without identities being revealed in the process    |  Tasks                 |  Should         
...
FRQ20  |  Members may offer help to the rest of the team without a specific request being present, to speed up any potential rendez-vous  |  Team                  |  Could          
...
NFRQ3  |  The app should provide offline sync, saving any state changes made during a period of no-connection  |  Persistence  |  Should         
...
![Deployment diagram showing the system's main components](../diagrams/deploymentDiagram.png)
...
![A simplified class diagram to illustrate the relationships between Factory, Manager and Linker contracts](../diagrams/simplifiedContractsClassDiagram.png)
...
![State mutations within a Redux architecture](../diagrams/redux.png)  
